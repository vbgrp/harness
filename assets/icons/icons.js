/**
 * Shared minimal icon library — Lucide (lucide-static v0.544.0) icons
 * inlined as static SVG strings so pages work fully offline, no runtime
 * network fetch. 24x24 viewBox, 2px stroke, round cap/join, currentColor.
 *
 * 182 icons across navigation, status, files, sharing, communication,
...
(function (global) {
  ...
  /**
   * Returns an inline <svg> markup string for the named icon.
  ...
  function svg(name, opts) {
    ...
    return '<svg xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size +
      ...
      '" stroke-linecap="round" stroke-linejoin="round" style="display:block" aria-hidden="true" focusable="false">' +
      inner + '</svg>';
  }
